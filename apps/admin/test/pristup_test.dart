...
class _Lazni implements StaffAccessRepository {
  final napravljeni = <(String, String)>[];
...
void main() {
  ...
  testWidgets('poziv: ime i uloga → kod koji se vidi jednom', (tester) async {
    final repo = _Lazni();
    ...
    expect(repo.napravljeni, [('employee', 'Selma')]);
