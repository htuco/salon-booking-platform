...
2. Složi layout po prototipu (`prototype/wireframe/src/app/pages/LandingPage.tsx`) koristeći komponente iz `core_ui`, ne nove ad-hoc widgete
...
## Zamke
- Prototip u `prototype/` je referenca za flow, **ne izvor komponenti** i više ne za vizual — vizual je u `prototype/ui/`. Ne prevodi Tailwind klase jedan-na-jedan; koristi tokene iz `core_ui`.
