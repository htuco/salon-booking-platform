...
> Wireframe demo u `prototype/src/app/` je React/web — to je **prototip za validaciju flowa**, ne production kod, i zamrznut je otkako vizual nosi [`design/`](../design/README.md). Mapiranje ekrana na Flutter screenove je u [02, §1.1](02-user-flows-wireframes.md).
